...
| <a name="input_envoy_default_allowed_hosts_exact"></a> [envoy\_default\_allowed\_hosts\_exact](#input\_envoy\_default\_allowed\_hosts\_exact) | Approved exact hostnames to allow through the Envoy proxy | `list(string)` | <pre>[<br/>  "sqs.eu-west-2.amazonaws.com",<br/>  "sts.eu-west-2.amazonaws.com",<br/>  "sns.eu-west-2.amazonaws.com",<br/>  "sqs.eu-west-1.amazonaws.com",<br/>  "sts.eu-west-1.amazonaws.com",<br/>  "sns.eu-west-1.amazonaws.com",<br/>  "agent.azureserviceprofiler.net",<br/>  "dc.services.visualstudio.com",<br/>  "o345774.ingest.sentry.io",<br/>  "o345774.ingest.us.sentry.io"<br/>]</pre> | no |
