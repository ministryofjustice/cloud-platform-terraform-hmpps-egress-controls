...
- `dc.services.visualstudio.com` - Azure Application Insights telemetry (Data Collection)
- `rt.services.visualstudio.com` - Azure Application Insights telemetry (Real-Time / Quick Pulse)
